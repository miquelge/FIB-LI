...
minCity:- importantCities(ListImportant), city(C, Locations), \+member(C, ListImportant),
	findall(used-S, member(S, Locations), Lits), atLeast(1, Lits), fail.
minCity.

minVIPCity:- importantCities(ListImportant), city(C, Locations), member(C, ListImportant),
	findall(used-S, member(S, Locations), Lits), atLeast(2, Lits), fail.
minVIPCity.

maxLocations:- numStations(Num), maxStations(Max), findall(used-S, between(0, Num, S), Lits),
